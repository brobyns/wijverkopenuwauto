...
@section('content')
    ...
    <div class="container content center-xs">
        <section>
            {{ Form:: open(array('action' => 'VehiclesController@store')) }}
            <div class="row">
                <div class="col-xs-12">
                    <h2>Voeg voertuig toe</h2>
                    <h3>Algemeen</h3>
                </div>
            ...
            <div class="row">
                <div class="col-xs-12">
                    <h3>Voertuigopties</h3>
                </div>
                <div class="col-xs-12">
                    <a href="#" id="addScnt">Voeg optie toe</a>
                </div>
            </div>
            <div id="properties">
            </div>
    ...
    <script>
        $(function () {
            ...
            var optiesDiv = $('#properties');
            var i = optiesDiv.length;

            $('#addScnt').click(function() {
                $('<div class="row group"><div class="col-xs-8"><input type="text" name="options[]" ' +
                        'value="" placeholder="Geef een optie in" /></div> ' +
                        '<div class="col-xs-4"><a href="#" id="remScnt">Verwijder</a></div></div>').appendTo(optiesDiv);
                i++;
                return false;
            });
            optiesDiv.on('click', 'a', function() {
                if( i > 0 ) {
